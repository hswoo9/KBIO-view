                    ...
                    <div className="contents JOIN_TYPE" id="contents">
                        ...
                        <div className="boxWrap">
                            ...
                            <div className="box box02" data-aos="fade-right" data-aos-duration="1500">
                                ...
                                <p class="tt2">
                                    네이버 아이디로 가입 신청하고 K-바이오 랩허브 <br/>홈페이지에서 로그인 합니다.
                                </p>
                                <ul className="buttonBox"  style={{marginBottom: "0",}}>
                                    <li className="naver">
                                        <button type="button"  onClick={() => handleNext("naver")}>
                                            <div className="icon"></div>
                                            <p style={{ margin: 0,textAlign: "center" }}>네이버 아이디 로그인</p></button>
                                    </li>
                                    <li className="google">
                                    ...
                                    <li className="kakao">
                                        <button type="button" onClick={() => handleNext("kakao")}>
                                            <div className="icon"></div>
                                            <p style={{ margin: 0,textAlign: "center" }}>카카오 아이디 로그인</p></button>
                                    </li>
                                </ul>
                            </div>
                        </div>
