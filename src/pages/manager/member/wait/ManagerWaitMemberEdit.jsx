...
function setWaitMember(props) {
    ...
    const initMode = () => {
        setModeInfo({
            ...
            editURL: `/memberApi/setWaitMember`,
        });
    ...
    const getWaitMember = (serachDto) => {
        ...
        const getWaitMemberURL = `/memberApi/getWaitMember`;
            ...
            if (result.isConfirmed) {
                ...
                EgovNet.requestFetch(setWaitMemberApprovalUrl, requestOptions, (resp) => {
                    if (Number(resp.resultCode) === Number(CODE.RCV_SUCCESS)) {
                        Swal.fire("승인되었습니다.");
                        navigate(URL.MANAGER_WAIT_MEMBER);
                    } else {
                    ...
                    <div className="buttonBox">
                        <div className="leftBox">
                            <button
                                ...
                                onClick={() => setWaitMemberApproval(memberDetail.userSn)}
                            >
                                <span>승인</span>
                            </button>
                            <button
                                type="button"
                                className="clickBtn gray"
                                onClick={() => setWaitMemberReject(memberDetail.userSn)}
                            >
                                <span>승인반려</span>
                            </button>

                        </div>
                        <Link to={URL.MANAGER_Wait_MEMBER}>
