...
function setStopMember(props) {
    ...
    const initMode = () => {
        setModeInfo({
            ...
            editURL: `/memberApi/setStopMember`,
        });

        getStopMember(searchDto);
    };
    ...
    const getStopMember = (serachDto) => {
        ...
        const getStopMemberURL = `/memberApi/getStopMember`;
        ...
        EgovNet.requestFetch(getStopMemberURL, requestOptions, function (resp) {
    ...
    const setStopMemberApproval = (userSn) => {
        const setStopMemberApprovalUrl = "/memberApi/setStopMemberApproval";
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                EgovNet.requestFetch(setStopMemberApprovalUrl, requestOptions, (resp) => {
                    if (Number(resp.resultCode) === Number(CODE.RCV_SUCCESS)) {
                        Swal.fire("승인되었습니다.");
                        navigate(URL.MANAGER_STOP_MEMBER);
                    } else {
                    ...
                    <div className="buttonBox">
                        <div className="leftBox">
                            ...
                            <button
                                ...
                                onClick={() => setStopMemberApproval(memberDetail.userSn)}
                            >
                                <span>재승인</span>
                            </button>

                        </div>
                        <Link to={URL.MANAGER_STOP_MEMBER}>
