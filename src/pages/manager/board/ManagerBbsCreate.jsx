                ...
                <dd>
                  ...
                  {modeInfo.mode === CODE.MODE_CREATE && (
                    <EgovRadioButtonGroup
                      ...
                      setter={(v) =>
                        setBoardDetail({ ...boardDetail, replyPosblAt: v })
                      }
                    />
                  )}
                  {/* 수정/조회 일때 변경 불가 */}
                  {modeInfo.mode === CODE.MODE_MODIFY && (
                    <span>
                      {boardDetail.replyPosblAt &&
                        getSelectedLabel(
                          replyPosblAtRadioGroup,
                          boardDetail.replyPosblAt
                        )}
                    </span>
                  )}
                  ...
                  <label className="f_select " htmlFor="posblAtchFileNumber">
                    <select
                      ...
                      onChange={(e) =>
                        setBoardDetail({
                          ...boardDetail,
                          posblAtchFileNumber: e.target.value,
                        })
                      }
